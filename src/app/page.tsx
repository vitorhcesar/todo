...
export default function Home() {
    ...
    return (
        <div className="flex min-h-screen flex-col items-center gap-20 p-10">
            <header>
                <h1 className='text-8xl'>🐨 Lista de tarefas 🐼</h1>
            </header>
            <main className='flex flex-col items-center justify-center w-screen'>
                <div className='flex items-center gap-2'>
                    <input 
                        ...
                        value={input} />
                    <button onClick={() => addNewTodo()}><IoMdAddCircle className='text-5xl text-purple-700 hover:text-purple-900 transition-all duration-500' /></button>
                </div>
